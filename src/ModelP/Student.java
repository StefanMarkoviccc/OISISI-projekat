...
public class Student {
	...
	public Student(String prezime, String ime, LocalDateTime datumR, String adresaStanovanja, String kontaktTel,
			String emailAdresa, String brIndexa, int godUpisa, TrenutnaGodina godina, Status status,
			double prosecnaOcena, ArrayList<Ocena> ocene, ArrayList<Predmet> nepolozeniPredmeti) {
		super();
		this.prezime = prezime;
		this.ime = ime;
		this.datumR = datumR;
